...
| v1.1.3.17 | ✅ ВЫПУЩЕН | 2026-06-15 | `58f7115` |
| v1.1.3.18+ | 🔨 В разработке | — | — |

**v1.1.3.17** — последняя версия с FAB AI + AIBottomSheet. Выпущен в сессии 17.
**v1.1.3.18+** — текущая разработка. Фокус: тестирование, доработки, новые фичи.
...
### Финальная архитектура v2 (уточнено ферзём, сессия 13)
...
├── Секция "Archived" (заархивированные, не удалённые)
└── Табы: All / AI / Groups
...
├── ArchiveChat/UnarchiveChat — уже есть ✅
