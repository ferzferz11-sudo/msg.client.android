...
**Версия:** v1.1.3.32
**Обновлено:** 2026-06-17 (сессия 40)
**Ветка:** feat/1.1.3.x
**Тег:** v1.1.3.32
...
|------|-----------|-------------|
| `PROMPT_ANDROID.md` | Промпт для новой сессии (статус + задачи + changelog) | **Всегда в начале** |
| `SESSION_NOTES.md` | Заметки сессий | В начале сессии |
| `SESSION_NOTES_ARCHIVE.md` | Архив сессий | Справочно |
