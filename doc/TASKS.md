...
### Высокий приоритет
- [x] **Remote Agent** — отдельная активити для удалённых агентов (токены, чат, настройки). Документация: `doc/REMOTE_AGENT.md`. Этапы 1-7 реализованы, тестирование после сборки APK.
