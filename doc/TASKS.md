...
### Высокий приоритет
- [x] **Remote Agent** — активити "Агенты" (чат + настройки токенов). Этапы 1-9 реализованы. Осталось: тестирование, интеграция с реальным агентом.

### Средний приоритет
- [ ] Модульные тесты для OWL streaming
- [ ] Интеграция чата агента с реальным агентом (сейчас echo-заглушка)
