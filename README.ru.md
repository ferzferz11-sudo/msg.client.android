# Lavender Messenger (Android клиент)

Защищенное приложение для обмена сообщениями

**Автор:** Pavel Davydov (ferz)

Приложение для защищенного обмена сообщениями в реальном времени с gRPC сервером и множественными клиентскими реализациями.

---

## Описание проекта

Lavender Messenger (Android клиент) - это нативное Android приложение, предназначенное для обмена сообщениями через систему Lavender Messenger. Приложение разработано на Kotlin с использованием современных Android практик и архитектурных подходов.
...
- 🎨 Новая цветовая палитра Lavender Messenger (Deep Purple, Lavender Mist, Soft Lilac, Silver Fog, Dark Slate)
